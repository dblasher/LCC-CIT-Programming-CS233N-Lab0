...
namespace TicTacToe
{
    public partial class TTTForm : Form
    {
        ...
        //this is another test comment occuring in the remote repo on github
        ...
        //* TODO:  finish these 2
        //sets all squares to empty text and calls enable all squares
        ...
        private void label_Click(object sender, EventArgs e)
        {
            ...
            {
                //user didn't win, so make the computer move
                MakeComputerMove();
            ...
            {
                //user won, so highlight the winner
